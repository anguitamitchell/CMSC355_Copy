"""
Django settings for RemediBackend project.
...
SECRET_KEY = 'django-insecure-#hrq*14nb^n(k9h_+walxi_fy_5*98+q+lm37ej$v!#)(=#e*6'
...
ROOT_URLCONF = 'RemediBackend.urls'
...
WSGI_APPLICATION = 'RemediBackend.wsgi.application'
